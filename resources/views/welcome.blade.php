        ...
        <main>
            <div class="container">
                ...
                {{-- <div class="wrapped">
                    ...
                    <button class="accept_btn btn_base">
                        Accept
                    </button>
                    <button class="deny_btn btn_base">
                        Deny
                    </button>
                    <button class="addNew_btn btn_base">
                        Add new
                    </button>
                    <button class="delete_btn btn_base">
                        Delete
                    </button>
                    <button class="orderNow_btn btn_base">
                        Order now
                    </button>
                    <button class="backTo_btn btn_base">
                        Back to
                    </button>
                </div>
                <div class="wrapper">
